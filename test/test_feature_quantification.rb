...
class TestFeatureQuantifications < Test::Unit::TestCase
  ...
  def test_create_index()
    ...
    assert_equal(feature_quant_file.index[["chr1",127573573,"GENE.886",1659]],793452)
  ...
  def test_transcript()
    feature_quant_file = FeatureQuantifications.new("test/data/test_feature_quant.txt")
    feature_quant_file.create_index
    transcript = feature_quant_file.transcript("chr1",127573573,"GENE.886",1659)
  ...
  def test_fpkm_for_transcript()
    ...
    feature_quant_file.create_index
    transcript = feature_quant_file.transcript("chr1",127573573,"GENE.886",1659)
    assert_equal(feature_quant_file.fpkm_for_transcript(transcript,1659),3.5)
  end
